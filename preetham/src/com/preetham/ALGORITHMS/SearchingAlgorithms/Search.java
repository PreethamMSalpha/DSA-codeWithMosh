package com.preetham.ALGORITHMS.SearchingAlgorithms;
...
public class Search {
    ...
    private int binarySearchRec(int[] array, int target, int left, int right) {
        if (right < left) //base condition for recursion
            return -1;
    ...
    public int jumpSearch(int[] array, int target) {
        ...
        int start = 0;
        int next = blockSize; //next represents index of next block
...
//      int[] numbers = {7,1,3,6,5};
        ...
        var res = search.exponentialSearch(numbers,7);
